...
DATA_PATH="${COIN_INSTR_ROOT}/VizWiz/train.json"
PREVIOUS_TASK_MODEL_PATH="${COIN_OUTPUT_ROOT}/GQA_llava_MoEMoKA_lora"
OUTPUT_DIR="${COIN_OUTPUT_ROOT}/VizWiz_llava_MoEMoKA_lora"

require_path "${COIN_BASE_MODEL}" "base model"
require_path "${COIN_VISION_TOWER}" "vision tower"
require_path "${DATA_PATH}" "VizWiz train json"
