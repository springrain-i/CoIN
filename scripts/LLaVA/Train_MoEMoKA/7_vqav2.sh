...
DATA_PATH="${COIN_INSTR_ROOT}/VQAv2/train.json"
PREVIOUS_TASK_MODEL_PATH="${COIN_OUTPUT_ROOT}/Grounding_llava_MoEMoKA_lora"
OUTPUT_DIR="${COIN_OUTPUT_ROOT}/VQAv2_llava_MoEMoKA_lora"
